    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4">
      ...
      <Card className="animate-scale-in relative z-10 w-full max-w-md border-white/10 bg-white/[0.97] shadow-2xl shadow-black/20 backdrop-blur-xl">
        <CardHeader className="items-center pb-2 pt-8">
          {/* Logo */}
          <div className="mb-3 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-navy-500 to-navy-700 p-3 shadow-xl shadow-navy-500/30">
            <Image
              src="/logo.png"
              alt="Logo Sekolah"
              width={56}
        ...
        <CardContent className="px-6 pb-8 pt-4">
          ...
          <div className="mt-6 rounded-lg bg-navy-50 p-3">
            ...
            <div className="space-y-1 text-xs text-navy-600">
              ...
              <p>
                <span className="font-medium">Guru:</span> 197601012005
              </p>
              <p>
                <span className="font-medium">Siswa:</span> 2024001
              </p>
              <p className="text-navy-400">Password: apa saja</p>
            </div>
          </div>
        </CardContent>
      </Card>
